...
<div class="mt-3">
  ...
  <form action="{{ route('create-user') }}" method="POST" enctype="multipart/form-data" id="create_form">
    @csrf
        ...
        <div class="card bg-base-100 shadow">
          <div class="card-body">
            ...
            <div class="fieldset mt-5 flex flex-wrap items-center gap-5 xl:flex-nowrap">
              ...
              <div class="flex items-center gap-3">
                <input class="toggle toggle-sm" id="is_active" type="checkbox" name="is_active"/>
        ...
        <div class="card-body">
          ...
          <div class="fieldset mt-2 grid grid-cols-1 gap-4 lg:grid-cols-2">
            ...
            <div class="space-y-2">
              ...
              <input class="input w-full" placeholder="(098) 765 4321" type="tel" name="phone_number_2" oninput="formatPhoneNumber(this)"/>
            </div>
            <div class="space-y-2">
